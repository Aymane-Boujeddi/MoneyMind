    ...
    <div class="min-h-screen relative">
        ...
        <div class="md:ml-64 p-4 md:p-8 pt-0">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
                ...
                <div
                    class="bg-gradient-to-br from-emerald-500 to-teal-600 rounded-xl shadow-lg p-6 hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1">
                ...
                <!-- Total Saved Card -->
                <div
                    class="bg-gradient-to-br from-blue-500 to-cyan-600 rounded-xl shadow-lg p-6 hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1">
                    <div class="flex items-center justify-between mb-4">
                        <div class="bg-white/20 p-3 rounded-lg">
            ...
            <div class="bg-white/90 backdrop-blur-xl rounded-xl shadow-lg border border-white/20 p-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                    <div
                        class="p-4 bg-gradient-to-br from-emerald-50 to-teal-100 rounded-xl border border-emerald-200">
                        <i class="fas fa-piggy-bank text-emerald-600 text-xl mb-2"></i>
                        <h4 class="font-medium text-gray-900 mb-1">50/30/20 Rule</h4>
                        <p class="text-sm text-gray-600">Allocate 50% for needs, 30% for wants, and 20% for savings.
                        </p>
                    </div>
                    <!-- Add more tips -->
                </div>
                ...
                <div
                    ...
                    <form action="" method="POST" class="space-y-6">
                        ...
                        <div>
                            ...
                            <input type="text" id="goalName" name="goalName" class="w-full px-4 py-2 rounded-lg border border-gray-300 focus:ring-2 focus:ring-purple-600 focus:border-transparent" placeholder="Enter goal name" required>
                        </div>
                        <div>
                            <label for="targetAmount" class="block text-sm font-medium text-gray-700 mb-2">Target Amount (DH)</label>
                            <div class="relative">
                                <span class="absolute left-3 top-1/2 transform -translate-y-1/2 text-gray-500">DH</span>
                                <input type="number" id="targetAmount" name="targetAmount" class="w-full pl-10 pr-4 py-2 rounded-lg border border-gray-300 focus:ring-2 focus:ring-purple-600 focus:border-transparent" placeholder="0.00" step="0.01" required>
                            </div>
                        </div>
                        <div>
                            <label for="targetDate" class="block text-sm font-medium text-gray-700 mb-2">Target Date</label>
                            <input type="date" id="targetDate" name="targetDate" class="w-full px-4 py-2 rounded-lg border border-gray-300 focus:ring-2 focus:ring-purple-600 focus:border-transparent" required>
                        </div>
                        <div class="flex justify-end space-x-3">
                            <button type="button" id="closeModalButton" class="bg-gray-200 text-gray-700 px-4 py-2 rounded-lg hover:bg-gray-300 transition-all duration-200">Cancel</button>
                            <button type="submit" class="bg-emerald-600 text-white px-4 py-2 rounded-lg hover:bg-emerald-700 transition-all duration-200">Save Goal</button>
                        </div>
                    </form>
                </div>
            </div>
