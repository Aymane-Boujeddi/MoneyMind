...
<body class="bg-gradient-to-br from-gray-50 via-purple-50 to-pink-50">
    <div x-data="{ sidebarOpen: false, modalOpen: false, activeTab: 'items' }" class="min-h-screen relative">
        <x-aside-nav />
            ...
            <div class="md:ml-64 p-4 md:p-8">
                <div class="flex flex-col md:flex-row justify-between items-start md:items-center">
                    ...
                    <div class="flex space-x-3 mt-4 md:mt-0">
                        <button class="bg-purple-500 text-white px-4 py-2 rounded-lg flex items-center hover:bg-purple-400 transition-colors">
                ...
                <div class="flex space-x-6 mt-8 border-b border-purple-500">
                    <button @click="activeTab = 'items'"
                        :class="{'text-white border-b-2 border-white': activeTab === 'items'}"
                        class="pb-4 text-purple-200 hover:text-white transition-colors">
                        <i class="fas fa-list mr-2"></i>
                        Items
                    </button>
                    <button @click="activeTab = 'savings'"
                        :class="{'text-white border-b-2 border-white': activeTab === 'savings'}"
                        class="pb-4 text-purple-200 hover:text-white transition-colors">
                        <i class="fas fa-piggy-bank mr-2"></i>
                        Savings
                    </button>
                    <button @click="activeTab = 'deals'"
                        :class="{'text-white border-b-2 border-white': activeTab === 'deals'}"
                        class="pb-4 text-purple-200 hover:text-white transition-colors">
        ...
        <div class="md:ml-64 p-4 md:p-8 pt-0">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
                <div class="bg-gradient-to-br from-purple-500 to-pink-500 rounded-xl shadow-lg p-6 hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1">
                    ...
                    <p class="text-sm text-white/90 mt-2">2 items near target</p>
                </div>

                <div class="bg-gradient-to-br from-blue-500 to-indigo-500 rounded-xl shadow-lg p-6 hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1">
                    <div class="flex items-center justify-between mb-4">
                        <div class="bg-white/20 p-3 rounded-lg">
                    ...
                    <p class="text-sm text-white/90 mt-2">Across all items</p>
                </div>
                ...
                <div class="bg-gradient-to-br from-green-500 to-emerald-500 rounded-xl shadow-lg p-6 hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1">
                    ...
                    <p class="text-sm text-white/90 mt-2">27% of total value</p>
                </div>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
                <!-- Enhanced Item Cards -->
                <div class="bg-white/90 backdrop-blur-xl rounded-xl shadow-lg overflow-hidden hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1 border border-white/20">
                    <div class="relative">
                        ...
                        <span class="absolute top-2 right-2 bg-gradient-to-r from-blue-500 to-blue-600 text-white text-xs px-3 py-1 rounded-full">
                            High Priority
                        </span>
                    </div>
                    <div class="p-6">
                ...
                <div class="bg-white/90 backdrop-blur-xl rounded-xl shadow-lg overflow-hidden hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1 border border-white/20">
                    <div class="relative">
                        ...
                        <span class="absolute top-2 right-2 bg-gradient-to-r from-yellow-500 to-yellow-600 text-white text-xs px-3 py-1 rounded-full">
                            Medium Priority
                        </span>
                    </div>
                    <div class="p-6">
            ...
            <div class="bg-white/90 backdrop-blur-xl rounded-xl shadow-lg p-6 border border-white/20">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                    <div class="p-4 bg-gradient-to-br from-blue-50 to-blue-100 rounded-lg border border-blue-200">
                        ...
                        <p class="text-sm text-gray-600">Wait for seasonal sales to get the best deals on your wishlist items.</p>
                    </div>
                    <div class="p-4 bg-gradient-to-br from-green-50 to-green-100 rounded-lg border border-green-200">
                        ...
                        <p class="text-sm text-gray-600">Check multiple retailers and set price alerts for better deals.</p>
                    </div>
